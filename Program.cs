...
// Configuração do DbContext usando MySQL
builder.Services.AddDbContext<DbContexto>(options => {
    options.UseMySql(
        builder.Configuration.GetConnectionString("NySql"),
...
app.MapPost("/administradores/login", ([FromBody] LoginDTO loginDTO, IAdministradorServico administradorServico) =>
{
    ...
    // ⚠️ Em produção, use hash de senha e banco de dados!
...
ErrosDeValidacao ValidaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (veiculoDTO.Ano < 1950)
        validacao.Mensagens.Add("Veículo muito antigo. Aceitamos somente anos a partir de 1950.");
